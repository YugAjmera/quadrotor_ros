...
{
    control_channel = nh_.resolveName("quadrotor/cmd_vel");
    dronepose_channel = nh_.resolveName("ardrone/predictedPose");
    command_channel = nh_.resolveName("tum_ardrone/com");
    takeoff_channel = nh_.resolveName("quadrotor/ardrone/takeoff");
    land_channel = nh_.resolveName("quadrotor/ardrone/land");
    toggleState_channel = nh_.resolveName("quadrotor/ardrone/reset");
